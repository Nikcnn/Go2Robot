...
def generate_launch_description() -> LaunchDescription:
    ...
    default_map = os.path.join(bringup_share, "maps", "site_a_floor_1.yaml")
    default_params = os.path.join(bringup_share, "params", "nav2_params.yaml")
    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                output="screen",
                parameters=[params_file, {"autostart": ParameterValue(autostart, value_type=bool)}],
            ),
            Node(
                package="nav2_lifecycle_manager",
                executable="lifecycle_manager",
            ...
            Node(
                package="go2_mission",
                executable="mission_api_node",
                name="go2_mission_api",
                output="screen",
            ),
            Node(
                package="rviz2",
