...
#ifndef GO2_INTERFACES__SRV__DETAIL__MISSION_CONTROL__FUNCTIONS_H_
#define GO2_INTERFACES__SRV__DETAIL__MISSION_CONTROL__FUNCTIONS_H_
 ...
 * calls
 * go2_interfaces__srv__MissionControl_Request__init().
...
/**
 * It calls
 * go2_interfaces__srv__MissionControl_Request__fini()
 ...
 * go2_interfaces__srv__MissionControl_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * go2_interfaces__srv__MissionControl_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * go2_interfaces__srv__MissionControl_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_interfaces
...
/**
 * It calls
 * go2_interfaces__srv__MissionControl_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * go2_interfaces__srv__MissionControl_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_go2_interfaces
...
/**
 * It calls
 * go2_interfaces__srv__MissionControl_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // GO2_INTERFACES__SRV__DETAIL__MISSION_CONTROL__FUNCTIONS_H_
